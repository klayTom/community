...
public class UploadController {
    ...
    @ResponseBody
    public FileDto Upload(@RequestParam(value = "editormd-image-file") MultipartFile file, HttpSession session) {
        if (file == null) {
        ...
        try {
            ...
            return new FileDto(1, "上传成功", this.path + putObjectRequest.getKey());
        } catch (IOException e) {
